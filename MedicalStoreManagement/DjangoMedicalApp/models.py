...
class Medicine(models.Model):
    ...
    sell_price=models.IntegerField(max_length=255)
    ...
    company_is=models.ForeignKey(Company,on_delete=models.CASCADE)
    description=models.CharField(max_length=255)
    in_stock_total=models.IntegerField(max_length=255)
    qty_in_strip=models.IntegerField(max_length=255)
    added_on=models.DateTimeField(auto_now_add=True)
    objects=models.Manager()
...
class CompanyAccount(models.Model):
    ...
    transaction_amt=models.CharField(choices=choices,max_length=255)
